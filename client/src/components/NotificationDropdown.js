    ...
    <div>
            ...
            {/* <!-- Dropdown menu --> */}
                ...
                <a href="#" class="flex items-center px-4 py-3 -mx-2 transition-colors duration-200 transform border-b bg-base-100 border-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-700 rounded-md">
                    ...
                    <p class="mx-2 text-sm text-gray-600 dark:text-white"><span class="font-bold" href="#">{notification.currentUserUsername}</span> {notification.interaction} <span class="font-bold text-blue-500" href="#">{notification.postDescription}</span></p>
                </a>
