                        ...
                        {cartItems.map((item) => (
                            ...
                            <div key={item.product._id} className="mt-4 md:mt-6 flex  flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                                <div className="pb-4 md:pb-8 w-full md:w-40">
                                    <img className="w-full hidden md:block rounded-xl" src={item.product.image} alt="dress" />
                                    <img className="w-full md:hidden rounded-xl" src={item.product.image}  alt="dress" />
                                </div>
